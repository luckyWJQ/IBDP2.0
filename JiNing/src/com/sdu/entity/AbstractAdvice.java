...
public abstract class AbstractAdvice implements Serializable {
	...
	private String a_isread;//是否已读 True表示已读，False表示未读
	...
	public AbstractAdvice(Integer a_id, String a_name, String a_content,
			String a_time, String a_isread, String a_type, Admin advice_admin) {
		this.a_id = a_id;
		this.a_name = a_name;
	...
	public String getA_isread() {
		return a_isread;
	}
	public void setA_isread(String a_isread) {
		this.a_isread = a_isread;
	}
